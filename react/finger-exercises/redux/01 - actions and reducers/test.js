...
describe('Actions', () => {
  ...
  xit('handle unknown action', () => {
    ...
    Some third-party libraries dispatch their own actions and have their own reducers to handle
    them.     We ignore their actions in our reducers and let the libraries handle them.
    */
